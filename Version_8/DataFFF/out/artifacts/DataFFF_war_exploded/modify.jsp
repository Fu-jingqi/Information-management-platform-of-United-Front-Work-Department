    ...
    <form action="<%=path%>/DoUpdateOrAddPersonServlet">
        <div class="bigBoxJ">
            ...
            <div class="input-group input-group-lg">
                ...
                <input type="text" class="form-control" placeholder="姓名" aria-describedby="sizing-addon1" name = "pname" value="${person.pname}">
            </div>
            ...
            <div class="input-group input-group-lg">
                <span class="input-group-addon" id="sizing-addon10">学位</span>
                <input type="text" class="form-control" placeholder="学位" aria-describedby="sizing-addon1" name="pxuewei" value="${person.pxuewei}">
            </div>

            <div class="input-group input-group-lg">
                <span class="input-group-addon" id="sizing-addon11">职称</span>
            ...
            <div class="input-group input-group-lg">
                <span class="input-group-addon" id="sizing-addon12">现任职务</span>
            ...
            <div class="input-group input-group-lg">
                <span class="input-group-addon" id="sizing-addon13">任同职级时间</span>
                <input type="date" class="form-control" placeholder="现任职务" aria-describedby="sizing-addon1" name="pTenureOfTheSameRank" value="${person.pTenureOfTheSameRank }">
            </div>

            <div class="input-group input-group-lg">
                <span class="input-group-addon" id="sizing-addon14">任现职级时间</span>
                <input type="date" class="form-control" placeholder="现任职务" aria-describedby="sizing-addon1" name="pLengthOfTenure" value="${person.pLengthOfTenure }">
            </div>

            <div class="input-group input-group-lg">
                <span class="input-group-addon" id="sizing-addon15">社会职务</span>
            ...
            <div class="input-group input-group-lg">
                <span class="input-group-addon" id="sizing-addon16">参加工作时间</span>
            ...
            <div class="input-group input-group-lg">
                <span class="input-group-addon" id="sizing-addon17">加入党派时间</span>
            ...
            <div class="input-group input-group-lg">
                <span class="input-group-addon" id="sizing-addon20">参政议政情况</span>
            ...
            <div class="input-group input-group-lg">
                <span class="input-group-addon" id="sizing-addon21">联系方式</span>
            ...
            <div class="input-group input-group-lg">
                <span class="input-group-addon" id="sizing-addon22">备注</span>
