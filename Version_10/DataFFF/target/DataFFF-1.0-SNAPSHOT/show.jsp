    ...
    <div class="content col-xs-11 col-sm-11 col-md-11 col-lg-11s">
        ...
        <div class="funcbar">
            <form action="/DataFFF_war_exploded/SelectByConditionServlet" method="post" class="form-inline">
                ...
                <div class="form-group">
                    <label>社会职务</label>
                    <input type="text" class="form-control" name="psocialwork" placeholder="请输入社会职务">
                </div>
                    ...
                    <form action="/DataFFF_war_exploded/ExcelDownServlet">
                        <table class = "fieldtab">
                            <tr>
                                ...
                                <td><input type="checkbox"  name="opt" value="psex"> <label>性别</label></td>
                                <td><input type="checkbox" name="opt" value="pbirth"><label>出生年月日</label></td>
                                <td><input type="checkbox" name="opt" value="pnational"> <label>民族</label></td>
                            </tr>
                            <tr>
                                <td><input type="checkbox" name="opt" value="pnativeplace"><label>籍贯</label></td>
                                <td><input type="checkbox" name="opt" value="ppoliticalstatus"> <label>政治面貌</label></td>
                                <td><input type="checkbox"  name="opt" value="pworkplace"> <label>工作单位</label></td>
                                <td><input type="checkbox" name="opt" value="pxueli"> <label>学历</label></td>
                                <td><input type="checkbox" name="opt" value="pxuewei"> <label>学位</label></td>
                            </tr>
                            <tr>
                                <td><input type="checkbox" name="opt" value="pzhicheng"><label>职称</label></td>
                                <td><input type="checkbox" name="opt" value="pcurrentposition"><label>现任职务</label></td>
<%--任同职级时间--%>              <td><input type="checkbox" name="opt" value="pTenureOfTheSameRank"><label>任同职级时间</label></td>
<%--任现职级时间--%>              <td><input type="checkbox" name="opt" value="pLengthOfTenure"><label>任现职级时间</label></td>
                                <td><input type="checkbox" name="opt" value="psocialwork"> <label>社会职务</label></td>
                            </tr>
                            <tr>
                                <td><input type="checkbox"  name="opt" value="pjoinworktime"> <label>参加工作时间</label></td>
                                <td><input type="checkbox" name="opt" value="pjoinpartytime"><label>加入党派时间</label></td>
                                <td><input type="checkbox" name="opt" value="phonor"> <label>获得荣誉</label></td>
                                <td><input type="checkbox" name="opt" value="ptraining"><label>培训情况</label></td>
                                <td><input type="checkbox" name="opt" value="pcanzhengyizheng"> <label>参政议政情况</label></td>
                            </tr>
                            <tr>
                                <td><input type="checkbox"  name="opt" value="pcontactnum"> <label>联系方式</label></td>
