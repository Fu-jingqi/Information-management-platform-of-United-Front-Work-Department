...
<body>
<div class="mianBox">
    <img src="../../../../DataFFF/web/images/yun0.png" alt="" class="yun yun0" />
    <img src="../../../../DataFFF/web/images/yun1.png" alt="" class="yun yun1" />
    <img src="../../../../DataFFF/web/images/yun2.png" alt="" class="yun yun2" />
    <img src="../../../../DataFFF/web/images/bird.png" alt="" class="bird" />
    <img src="../../../../DataFFF/web/images/san.png" alt="" class="san" />
    <div class="tipInfo">
        <div class="in">
            <div class="textThis">
                <h2>用户信息出错，请重新登录</h2>
                <p><span>请点击<a id="href" href="../../../../DataFFF/web/login.jsp">跳转</a>返回登录界面</span></p>
