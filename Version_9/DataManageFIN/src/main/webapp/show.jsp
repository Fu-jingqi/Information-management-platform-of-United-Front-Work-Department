<%@ page import="com.util.PageHelper" %><%--
    ...
    <div class="panel panel-default">
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td><a href="<%=path%>/GetAllPersonByPageServlet?pageNo=1">首页</a></td>
                <td><a href="<%=path%>/GetAllPersonByPageServlet?pageNo=${ph.pageNo-1}">上一页</a></td>
                <%
                    }
                    if(pNo < ph.getPageCount()){
                %>
                <td><a href="<%=path%>/GetAllPersonByPageServlet?pageNo=${ph.pageNo+1}">下一页</a></td>
                <td><a href="<%=path%>/GetAllPersonByPageServlet?pageNo=${ph.pageCount}">尾页</a></td>
                <%
                    }
                %>
            </tr>
